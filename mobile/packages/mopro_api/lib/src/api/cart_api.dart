...
class CartApi {
  ...
  Future<Response<Cart>> addCartItem({ 
...
_responseData = rawData == null ? null : deserialize<Cart, Cart>(rawData, 'Cart', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
...
_responseData = rawData == null ? null : deserialize<Cart, Cart>(rawData, 'Cart', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> releaseCart({ 
    required String xIdempotencyKey,
    required ReleaseCartRequest releaseCartRequest,
    String? xTraceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
_bodyData=jsonEncode(releaseCartRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeCartItem({ 
    required String xIdempotencyKey,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Reservation] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reservation>> reserveCart({ 
    required String xIdempotencyKey,
    String? xTraceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    Reservation? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<Reservation, Reservation>(rawData, 'Reservation', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
