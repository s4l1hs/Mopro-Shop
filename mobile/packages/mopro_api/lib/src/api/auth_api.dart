...
class AuthApi {
  ...
  Future<Response<void>> logout({ 
    ...
    try {
_bodyData=jsonEncode(refreshTokenRequest);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPair>> refreshToken({ 
    required String xIdempotencyKey,
    required RefreshTokenRequest refreshTokenRequest,
    String? xTraceId,
    CancelToken? cancelToken,
...
_responseData = rawData == null ? null : deserialize<TokenPair, TokenPair>(rawData, 'TokenPair', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> requestOtp({ 
    required RequestOtpRequest requestOtpRequest,
    String? xTraceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
_bodyData=jsonEncode(requestOtpRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StepUpTokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StepUpTokenResponse>> stepUp({ 
    required String xIdempotencyKey,
    required StepUpRequest stepUpRequest,
    String? xTraceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
_bodyData=jsonEncode(stepUpRequest);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
    ...
    StepUpTokenResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<StepUpTokenResponse, StepUpTokenResponse>(rawData, 'StepUpTokenResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<StepUpTokenResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
