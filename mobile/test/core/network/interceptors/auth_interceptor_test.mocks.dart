...
// in mopro/test/core/network/interceptors/auth_interceptor_test.dart.
...
import 'package:mopro/core/storage/token_storage.dart' as _i8;
...
class MockTokenStorage extends _i1.Mock implements _i8.TokenStorage {
  ...
  @override
  _i9.Future<String?> readAccessToken() => (super.noSuchMethod(
        Invocation.method(
          #readAccessToken,
          [],
        ),
  ...
  @override
  _i9.Future<String?> readRefreshToken() => (super.noSuchMethod(
        Invocation.method(
          #readRefreshToken,
          [],
        ),
