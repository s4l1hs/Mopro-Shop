...
✅ RESOLVED** (`feat/bestseller-sort`, Pattern B in-process, global scope; category-scope → **P-031**). **The
pure-UI parity work is done.** Remaining (all backend/architectural): P-007 (delivery-ETA), P-030 (price-history),
...
**Status: ✅ RESOLVED (Pattern B — in-process read, global scope) | Severity: MED | Confidence: CONFIRMED | Type: backend**
