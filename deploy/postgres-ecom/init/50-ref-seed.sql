...
-- The match consumes alpha only; EU rows prove the numeric axis is representable.
-- STANDARD baseline, NOT per-brand truth — seller charts override later; the API
-- still flags chart_approximate=true. See docs/internal/size-fit.md §curation.
...
VALUES
  ...
  -- EU numeric reference (parallel axis; not consumed by the match)
